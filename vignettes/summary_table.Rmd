...
- **Remove rows with no data**: Checkbox that controls whether to hide rows that have no analysis data. Row groupings
  can result in many unwanted combinations, e.g. when grouped by country and site it is inappropriate to show all sites
  under all countries since a site only applies to one country.
