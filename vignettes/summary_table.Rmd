...
- Aggregation of multiple subject results corresponding to a grouping (e.g. multiple lab results for a subject at a
  single visit) can be specified using an aggregation function.
