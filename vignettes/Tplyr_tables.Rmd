...
The Tplyr table module can display tables created with `{Tplyr}`, standalone listings, or both.
...
`default_vars`, `pagination`, `intended_use_label`, `receiver_id`, `review` are all agrguments that are passed through to `{dv.listings}`. more information can be found [here]{https://boehringer-ingelheim.github.io/dv.listings/}
