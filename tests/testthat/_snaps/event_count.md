# counting is correct, sorting, against (snapshot)__spec_ids{hierarchical_count_table$event_count;hierarchical_count_table$event_count_display;hierarchical_count_table$sorted_table_display;hierarchical_count_table$total_column_display}
    ...
    Output
      $df
      # A tibble: 28 x 8
         lvl1     lvl2     group `\035lvl`     N     n subjid      pct
         <fct>    <fct>    <fct>     <int> <int> <int> <list>    <dbl>
       1 "\u001d" "\u001d" GA            0     1     1 <fct [1]>   100
       2 "\u001d" "\u001d" GB            0     1     1 <fct [1]>   100
       3 "\u001d" "\u001d" GC            0     2     1 <fct [1]>    50
       4 "\u001d" "\u001d" Total         0     4     3 <fct [3]>    75
       5 "A1"     "\u001d" GA            1     1     1 <fct [1]>   100
       6 "A1"     "\u001d" GB            1     1     1 <fct [1]>   100
       7 "A1"     "\u001d" GC            1     2     1 <fct [1]>    50
       8 "A1"     "\u001d" Total         1     4     3 <fct [3]>    75
       9 "A1"     "A2"     GA            2     1     1 <fct [1]>   100
      10 "A1"     "A2"     GB            2     1     1 <fct [1]>   100
      # i 18 more rows
      ...
      <div>
        ...
        <table class="table event-count">
          ...
          <tr row-id="12" class="indent-2" indent="2">
            ...
            <td class="text-center" column="F" onclick="Shiny.setInputValue(&#39;mod-cell_click&#39;, {row_id: Number(this.closest(&#39;tr&#39;).getAttribute(&#39;row-id&#39;)), column : this.getAttribute(&#39;column&#39;)}, {priority: &#39;event&#39;})">0 ( 0.00 %)</td>
          ...
          <tr row-id="15" class="indent-2" indent="2">
            ...
            <td class="text-center" column="M" onclick="Shiny.setInputValue(&#39;mod-cell_click&#39;, {row_id: Number(this.closest(&#39;tr&#39;).getAttribute(&#39;row-id&#39;)), column : this.getAttribute(&#39;column&#39;)}, {priority: &#39;event&#39;})">0 ( 0.00 %)</td>
